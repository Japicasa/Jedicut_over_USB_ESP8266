...
int stepmin_period = 1000;              //microseconds, Fast Speed (here is 1.000Hz pulse rate)  change this to change desired speed, the lowest limit: overlapping interrupts, vibrations in the table... 
int stepmax_period = 2000;           //microseconds,  Cut speed (here is 500Hz pulse rate)   change this to change desired speed, the limit: your patience as speed will go ... 
